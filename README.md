...
This repository contains the examples discussed in the Image Processing practices. Each folder includes the source code for these exercises. Explanations, figures, and theoretical background are available on the course website.
